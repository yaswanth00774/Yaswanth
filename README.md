...
<body>
    <header><div class="header-content">
            ...
            <img src="yaswantho.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>yaswanth k</h1>
            <p>Am BCA</p>
        </div>
    </header>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I'm  <b>yaswanth</b> 2bca student for BHARATHIDASAN
...
COLLEGE OF ARTS AND SCIENCE</p>
    ...
    <section id="education">
        <div class="section-content">
            <h2>Education</h2>
            <p> bharathiyar University  - bca</p>
